...
function romanToInt(rom) {
  let arrayString = rom.toUpperCase()
  // let myArray = arrayString.split(" ")

  let arrString = ["I", "V", "X", "L", "C", "D", "M"]
  let arrNumber = [1, 5, 10, 50, 100, 500, 1000]
  for (let i = 0; i < arrString.length; i++) {
    console.log(arrayString.charAt(i))
    // if (arrString.includes(arrayString.charAt(i))) {
    //   return true
    // }
  }
  // if (rom.charAt(0) === rom.charAt(1)) {
  //   return rom.charAt(0) + rom.charAt(1)
  // }
}
let str = "lv"
